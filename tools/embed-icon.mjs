 ...
 *
 * Usage:
 *   node tools/embed-icon.mjs bomb                       # from assets/lucide
 *   node tools/embed-icon.mjs arrow-left-right --key icoRow
 *   node tools/embed-icon.mjs bomb --size 128 --stroke 2.6 --color "#ffd43b"
 *   node tools/embed-icon.mjs path/to/custom.svg --key icoThing
 */
...
if (!name) {
  console.error("Usage: node tools/embed-icon.mjs <lucide-name|file.svg> [--key k] [--size 96] [--stroke 2.2] [--color '#ffffff']");
  process.exit(1);
}
