 ...
 *
 * Usage:
 *   node tools/build/check-size.mjs                 # scan games/ (default 5 MB)
 *   node tools/build/check-size.mjs games/x/index.html
 *   node tools/build/check-size.mjs --limit 2       # 2 MB budget
 */
